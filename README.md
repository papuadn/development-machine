...
## Adobe
- [Creative Cloud](https://creativecloud.adobe.com/en/apps/download/creative-cloud)
  - Adobe Acrobat DC
  - Adobe After Effects
  - Adobe Illustrator
  - Adobe InDesign
...
> **Note**: This also means that when you _clone_ a repo, you'll need to use the **clone with SSH** URL. 
...
## Spotify
https://www.spotify.com/au/download/other/
